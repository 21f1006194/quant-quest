...
class GamePlay:
    ...
    def get_game_data(self):
        response = requests.get(
            f"{BASE_URL}/play/signal_sequence",
    ...
    def bet(self, choice, bet_amount):
        if choice not in ["Red", "Blue", "Green", "Yellow", "Purple"]:
            raise Exception(
                "Choice must be 'Red', 'Blue', 'Green', 'Yellow', or 'Purple'"
            )
        payload = {
...
if __name__ == "__main__":
    print("Playing the Signal Sequence game...")
    game = GamePlay()
