<template>
    <div class="game-page">
      ...
      <div v-if="gameData" class="game-info">
        ...
        <div class="how-to-play">
          <h2>How to Play</h2>
          <p>
            To play the game, send a POST request to the endpoint
            <code>/play/fiber_files</code>. Include your API token in the header as
    ...
    "bet_amount": number
            ...
            <ul>
              <li><code>choice</code>: Your chosen suspect (from 0 to 9).</li>
  ...
  onMounted(async () => {
    template.value = await getGameTemplate('fiber_files')
  })
  </script>
